...
open class CryptoJS {
    ...
    open class AES: CryptoJS {
        ...
        override init() {
            ...
            let cryptoJSpath = Bundle(for: VAChatViewController.self).path(forResource: "aes", ofType: "js")
            ...
            if ( cryptoJSpath ) != nil {
                do {
                    ...
                    debugPrint("Unable to load aes.js")
                }
            } else {
                debugPrint("Unable to find aes.js")
            }
        ...
        override init() {
            ...
            if ( cryptoJSpath ) != nil {
                do {
                    ...
                    debugPrint("Unable to load tripledes.js")
                }
            } else {
                debugPrint("Unable to find tripledes.js")
            }
    ...
    open class DES: CryptoJS {
        ...
        override init() {
            ...
            if ( cryptoJSpath ) != nil {
                do {
                    let cryptoJS = try String(contentsOfFile: cryptoJSpath!, encoding: String.Encoding.utf8)
                    debugPrint("Loaded tripledes.js (DES)")
                    ...
                    debugPrint("Unable to load tripledes.js (DES)")
                }
            } else {
                debugPrint("Unable to find tripledes.js (DES)")
            }
        ...
        override init() {
            ...
            if ( cryptoJSpath ) != nil {
                ...
                do {
                    ...
                    debugPrint("Unable to load md5.js")
                }

            } else {
                debugPrint("Unable to find md5.js")
            }
        ...
        override init() {
            ...
            if ( cryptoJSpath ) != nil {
                ...
                do {
                    ...
                    debugPrint("Unable to load sha1.js")
                }

            } else {
                debugPrint("Unable to find sha1.js")
            }
        ...
        override init() {
            ...
            if ( cryptoJSpath ) != nil {
                ...
                do {
                    ...
                    debugPrint("Unable to load sha224.js")
                }

            } else {
                debugPrint("Unable to find sha224.js")
            }
        ...
        override init() {
            ...
            if ( cryptoJSpath ) != nil {
                ...
                do {
                    ...
                    debugPrint("Unable to load sha256.js")
                }

            } else {
                debugPrint("Unable to find sha256.js")
            }
        ...
        override init() {
            ...
            if ( cryptoJSpath ) != nil {
                ...
                do {
                    ...
                    debugPrint("Unable to load sha384.js")
                }

            } else {
                debugPrint("Unable to find sha384.js")
            }
        ...
        override init() {
            ...
            if ( cryptoJSpath ) != nil {
                do {
                    ...
                    debugPrint("Unable to load sha512.js")
                }

            } else {
                debugPrint("Unable to find sha512.js")
            }
        ...
        override init() {
            ...
            if ( cryptoJSpath ) != nil {
                ...
                do {
                    ...
                    debugPrint("Unable to load sha3.js")
                }
            }
        ...
        override init() {
            ...
            if ( cryptoJSpath ) != nil {
                ...
                do {
                    ...
                    debugPrint("Loaded ripemd160.js")
                    ...
                    debugPrint("Unable to load ripemd160.js")
                }
        ...
        open class CFB: CryptoJS {
            override init() {
                ...
                if ( cryptoJSpath ) != nil {
                    do {
                        let cryptoJS = try String(contentsOfFile: cryptoJSpath!, encoding: String.Encoding.utf8)
                        debugPrint("Loaded mode-\(CryptoJS.mode().CFB).js")
                        // Evaluate script
                        _ = cryptoJScontext?.evaluateScript(cryptoJS)
                    } catch {
                        debugPrint("Unable to load mode-\(CryptoJS.mode().CFB).js")
                    }
                }
            }
        }
        open class CTR: CryptoJS {
            override init() {
                ...
                if ( cryptoJSpath ) != nil {
                    do {
                        let cryptoJS = try String(contentsOfFile: cryptoJSpath!, encoding: String.Encoding.utf8)
                        debugPrint("Loaded mode-\(CryptoJS.mode().CTR).js")
                        // Evaluate script
                        _ = cryptoJScontext?.evaluateScript(cryptoJS)
                    } catch {
                        debugPrint("Unable to load mode-\(CryptoJS.mode().CTR).js")
                    }
                }
            }
        }
        ...
        open class OFB: CryptoJS {
            override init() {
                ...
                if ( cryptoJSpath ) != nil {
                    do {
                        let cryptoJS = try String(contentsOfFile: cryptoJSpath!, encoding: String.Encoding.utf8)
                        debugPrint("Loaded mode-\(CryptoJS.mode().OFB).js")
                        // Evaluate script
                        _ = cryptoJScontext?.evaluateScript(cryptoJS)
                    } catch {
                        debugPrint("Unable to load mode-\(CryptoJS.mode().OFB).js")
                    }
                }
            }
        }
        ...
        open class ECB: CryptoJS {
            override init() {
                ...
                if ( cryptoJSpath ) != nil {
                    do {
                        let cryptoJS = try String(contentsOfFile: cryptoJSpath!, encoding: String.Encoding.utf8)
                        debugPrint("Loaded mode-\(CryptoJS.mode().ECB).js")
                        // Evaluate script
                        _ = cryptoJScontext?.evaluateScript(cryptoJS)
                    } catch {
                        debugPrint("Unable to load mode-\(CryptoJS.mode().ECB).js")
                    }
                }
            }
        }
        ...
        open class AnsiX923: CryptoJS {
            override init() {
                ...
                if ( cryptoJSpath ) != nil {
                    do {
                        let cryptoJS = try String(contentsOfFile: cryptoJSpath!, encoding: String.Encoding.utf8)
                        debugPrint("Loaded pad-\(CryptoJS.pad().AnsiX923).js")
                        // Evaluate script
                        _ = cryptoJScontext?.evaluateScript(cryptoJS)
                    } catch {
                        debugPrint("Unable to load pad-\(CryptoJS.pad().AnsiX923).js")
                    }
                }
            }
        }
        ...
        open class Iso97971: CryptoJS {
            override init() {
                ...
                if ( cryptoJSpath ) != nil {
                    do {
                        let cryptoJS = try String(contentsOfFile: cryptoJSpath!, encoding: String.Encoding.utf8)
                        debugPrint("Loaded pad-\(CryptoJS.pad().Iso97971).js")
                        // Evaluate script
                        _ = cryptoJScontext?.evaluateScript(cryptoJS)
                    } catch {
                        debugPrint("Unable to load pad-\(CryptoJS.pad().Iso97971).js")
                    }
                }
            }
        }
        ...
        open class Iso10126: CryptoJS {
            override init() {
                ...
                if ( cryptoJSpath ) != nil {
                    do {
                        let cryptoJS = try String(contentsOfFile: cryptoJSpath!, encoding: String.Encoding.utf8)
                        debugPrint("Loaded pad-\(CryptoJS.pad().Iso10126).js")
                        // Evaluate script
                        _ = cryptoJScontext?.evaluateScript(cryptoJS)
                    } catch {
                        debugPrint("Unable to load pad-\(CryptoJS.pad().Iso10126).js")
                    }
                }
            }
        }
        ...
        open class ZeroPadding: CryptoJS {
            override init() {
                ...
                if ( cryptoJSpath ) != nil {
                    do {
                        let cryptoJS = try String(contentsOfFile: cryptoJSpath!, encoding: String.Encoding.utf8)
                        debugPrint("Loaded pad-\(CryptoJS.pad().ZeroPadding).js")
                        // Evaluate script
                        _ = cryptoJScontext?.evaluateScript(cryptoJS)
                    } catch {
                        debugPrint("Unable to load pad-\(CryptoJS.pad().ZeroPadding).js")
                    }
                }
            }
        }
        ...
        open class NoPadding: CryptoJS {
            override init() {
                ...
                if ( cryptoJSpath ) != nil {
                    do {
                        let cryptoJS = try String(contentsOfFile: cryptoJSpath!, encoding: String.Encoding.utf8)
                        debugPrint("Loaded pad-\(CryptoJS.pad().NoPadding).js")
                        // Evaluate script
                        _ = cryptoJScontext?.evaluateScript(cryptoJS)
                    } catch {
                        debugPrint("Unable to load pad-\(CryptoJS.pad().NoPadding).js")
                    }
                }
            }
        }
