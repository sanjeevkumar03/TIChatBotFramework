...
@IBDesignable
final public class SwiftSignatureView: UIView {
    ...
    /// Save signature (cropped of outside white space) as a UIImage
    ...
    /// Save signature as a Vector PDF Data blob
...
extension SwiftSignatureDelegate {
    func didStart() {}
    func didFinish() {}
}
