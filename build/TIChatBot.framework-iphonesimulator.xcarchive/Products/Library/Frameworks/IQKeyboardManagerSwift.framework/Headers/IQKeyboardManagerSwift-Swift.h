...
typedef SWIFT_ENUM(NSInteger, IQAutoToolbarManageBehavior, open) {
...
SWIFT_CLASS("_TtC22IQKeyboardManagerSwift23IQKeyboardConfiguration") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
@property (nonatomic, readonly, strong) IQToolbarConfiguration * _Nonnull toolbarConfiguration;
/// Configuration related to keyboard appearance
@property (nonatomic, readonly, strong) IQKeyboardConfiguration * _Nonnull keyboardConfiguration;
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface IQKeyboardManager (SWIFT_EXTENSION(IQKeyboardManagerSwift))
- (void)registerKeyboardSizeChangeWithIdentifier:(NSObject * _Nonnull)identifier sizeHandler:(void (^ _Nonnull)(CGSize))sizeHandler SWIFT_UNAVAILABLE_MSG("This feature has been moved to IQKeyboardListener, use it directly by creating new instance");
- (void)unregisterKeyboardSizeChangeWithIdentifier:(NSObject * _Nonnull)identifier SWIFT_UNAVAILABLE_MSG("This feature has been moved to IQKeyboardListener, use it directly by creating new instance");
@property (nonatomic, readonly) BOOL keyboardShowing SWIFT_UNAVAILABLE_MSG("This feature has been moved to IQKeyboardListener, use it directly by creating new instance");
@property (nonatomic, readonly) CGRect keyboardFrame SWIFT_UNAVAILABLE_MSG("This feature has been moved to IQKeyboardListener, use it directly by creating new instance");
@end
...
@class IQToolbarPlaceholderConfiguration;

SWIFT_CLASS("_TtC22IQKeyboardManagerSwift22IQToolbarConfiguration") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
@property (nonatomic) enum IQAutoToolbarManageBehavior manageBehavior;
...
@property (nonatomic, readonly, strong) IQToolbarPlaceholderConfiguration * _Nonnull placeholderConfiguration;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC22IQKeyboardManagerSwift33IQToolbarPlaceholderConfiguration") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface UIView (SWIFT_EXTENSION(IQKeyboardManagerSwift))
@property (nonatomic, strong) IQToolbar * _Nonnull keyboardToolbar SWIFT_UNAVAILABLE_MSG("'keyboardToolbar' has been renamed to 'iq.toolbar'");
